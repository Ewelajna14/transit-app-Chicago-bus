...
This project is a simple bus schedule app, showing the real time data for Chicago 
User has to create username and password to be able to use the app. 
After being successfully logged in user can browse schedule info for every bus in Chicago, which contains
time of arrival to particular stop and location of the bus stop on the map. 
User is able create shortcut for his favourite bus lines for faster access. 
Moreover user can check stations for the Divvy bicycle sharing station displayed on the map.

Data needed for creating this project are coming from CTA Bus API 
API documentation: 
https://www.transitchicago.com/developers/bustracker/
and Divvy Bikes Chicago
...
```console
$ git clone https://github.com/Ewelajna14/transit-app your-project-name
...
![Getting Started](./image/line_detail.jpg)
